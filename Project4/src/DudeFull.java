...
public class DudeFull extends Dude {
    ...
    public DudeFull(Point position, List<PImage> images, int imageIndex, String id, String kind, double animationPeriod, double actionPeriod, int resourceLimit, PathingStrategy strategy) {
    ...
    public boolean transform(WorldModel world, EventScheduler scheduler, ImageStore imageStore) {
        Dude dude = new DudeNotFull(this.getPosition(), this.getImages(), 0, this.getId(),
                Dude.DUDE_KEY, this.getAnimationPeriod(), this.getActionPeriod(), this.getResourceLimit(), 0, Dude.DUDE_STRATEGY);
