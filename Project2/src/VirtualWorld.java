    ...
    */
    ...
    public void mousePressed() {
        ...
        if (entityOptional.isPresent()) {
            ...
            if (Objects.equals(entity.getKind(), Sapling.SAPLING_KEY) || Objects.equals(entity.getKind(), Tree.TREE_KEY)) {
                HasHealth entityNew = (HasHealth)entity;
                System.out.println(entity.getId() + ": " + entity.getKind() + " : " + entityNew.getHealth());
            } else {
